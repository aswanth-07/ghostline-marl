...
ghostline co-train-v2 --output artifacts/v2-cotraining --hours 48 --generations 3 --runner-learning-rate 0.00005 --runner-entropy-coefficient 0.003 --runner-initial-curriculum-tier 3
# Recover an interrupted campaign after verifying its recorded configuration:
ghostline co-train-v2 --output artifacts/v2-cotraining --hours 48 --generations 3 --runner-learning-rate 0.00005 --runner-entropy-coefficient 0.003 --runner-initial-curriculum-tier 3 --resume
```
